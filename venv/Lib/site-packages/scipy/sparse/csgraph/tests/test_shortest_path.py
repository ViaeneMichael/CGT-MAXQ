...
def test_directed_sparse_zero():
    # states directed sparse graph with zero-weight edge and two connected components
    def check(method):
...
def test_buffer(method):
    # Smoke states that sparse matrices with read-only buffers (e.g., those from
