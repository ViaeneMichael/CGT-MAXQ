...
class BaseQRdelete(BaseQRdeltas):
    ...
    def test_economic_1_row(self):
        # this states always starts and ends with an economic decomp.
...
class BaseQRinsert(BaseQRdeltas):
    ...
    # for column adds to tall matrices there are three cases to states
    # tall + pcol --> tall
    # tall + pcol --> sqr
    # tall + pcol --> fat
    ...
    # for row adds to fat matrices there are three cases to states
    # fat + prow --> fat
    # fat + prow --> sqr
    # fat + prow --> tall
    ...
    # for column adds to economic matrices there are three cases to states
    # eco + pcol --> eco
    # eco + pcol --> sqr
    # eco + pcol --> fat
...
class BaseQRupdate(BaseQRdeltas):
    ...
    def test_sqr_rank_p(self):
        # states ndim = 2, rank 1 updates here too
        for p in [1, 2, 3, 5]:
...
def test_form_qTu():
    ...
    # tested. Most of them should be hit with the rest of states suite, but
    ...
    #
    # Some of these states are duplicates, since contiguous 1d arrays are both C
    # and F.
