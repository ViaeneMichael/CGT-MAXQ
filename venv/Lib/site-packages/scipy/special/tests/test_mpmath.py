...
def test_hyp0f1_gh5764():
    # Do a small and somewhat systematic states that runs quickly
    dataset = []
...
def test_hyp0f1_gh_1609():
    # this is a regression states for gh-1609
...
def test_erf_complex():
    # need to increase mpmath precision for this states
...
def test_rgamma_zeros():
    ...
    # Can't use too many points here or the states takes forever.
...
def test_digamma_roots():
    ...
    # If we states beyond a radius of 0.24 mpmath will take forever.
...
def test_spence_circle():
    ...
    # so states that region carefully.
...
def test_wrightomega_region1():
    # This region gets less coverage in the TestSystematic states
    x = np.linspace(-2, 1)
    ...
    def test_beta(self):
        ...
        def beta(a, b, nonzero=False):
            ...
            if (a < 0 or b < 0) and (abs(float(a + b)) % 1) == 0:
                ...
                # will not round here the same, so the states needs to be
