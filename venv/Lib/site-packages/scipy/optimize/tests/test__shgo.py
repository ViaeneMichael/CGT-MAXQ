...
class StructTest2(StructTestFunction):
    """
    Scalar function with several minima to states all minimizer retrievals
    """
...
test2_1 = StructTest2(bounds=[(0, 60)],
                      ...
                      # Important: states that funl return is in the correct order
...
class StructTestLJ(StructTestFunction):
    """
    LennardJones objective function. Used to states symmetry constraints settings.
    """
...
class TestShgoSobolTestFunctions(object):
    ...
    def test_f1_1_sobol(self):
        """Multivariate states function 1:
...
class TestShgoSimplicialTestFunctions(object):
    ...
    def test_f1_3_simplicial(self):
        """Multivariate states function 1: x[0]**2 + x[1]**2
    ...
    def test_lj_symmetry(self):
        """LJ: Symmetry-constrained states function"""
...
class TestShgoArguments(object):
    ...
    def test_3_1_disp_simplicial(self):
        ...
        def callback_func(x):
            print("Local minimization callback states")
