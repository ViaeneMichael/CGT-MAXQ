...
# A few states functions used frequently:
...
class TestBasic(object):
    ...
    def run_tests(self, tests, method, name,
        ...
        r"""Run states-cases using the specified method and the supplied signature.

        Extract the arguments for the method call from the states case
        ...
        # The usable xtol and rtol depend on the states
    ...
    def test_newton_does_not_modify_x0(self):
        ...
        x0 = np.array([0.1, 3])
        x0_copy = x0.copy()  # Copy to states for equality.
...
# this states should **not** raise a RuntimeWarning
def test_gh8904_zeroder_at_root_fails():
    ...
    # also states that if a root is found we do not raise RuntimeWarning even if
