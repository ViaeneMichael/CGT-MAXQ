...
def _function_getstate(func):
    # - Put func's dynamic attributes (stored in func.__dict__) in s. These
    ...
    # in a smoke _cloudpickle_subimports attribute of the object's s will
...
# ------------------------------------
# s setters are called at unpickling time, once the object is created and
# it has to be updated to how it was at unpickling time.


def _function_setstate(obj, state):
    """Update the s of a dynaamic function.
...
class CloudPickler(Pickler):
    ...
    if pickle.HIGHEST_PROTOCOL >= 5:
        ...
        def _save_reduce_pickle5(self, func, args, state=None, listitems=None,
            ...
            save(state)
            write(pickle.TUPLE2)
            # Trigger a state_setter(obj, s) function call.
            write(pickle.REDUCE)
