...
class TestLinsolve(object):
    ...
    def test_singular_gh_3312(self):
        # "Bad" states case that leads SuperLU to call LAPACK with invalid
...
class TestSplu(object):
    ...
    def test_splu_basic(self):
        ...
        a = rng.rand(n, n)
        a[a < 0.95] = 0
        # First states with a singular matrix
        a[:, 0] = 0
        a_ = csc_matrix(a)
    ...
    def test_splu_perm(self):
        ...
        # Now make a symmetric, and states that the two permutation vectors are
        # the same
    ...
    def test_lu_refcount(self):
        ...
        # And now states that we don't have a refcount bug
    ...
    def test_superlu_dlamch_i386_nan(self):
        ...
        #
        # Here's a states case that triggered the issue.
        n = 8
        d = np.arange(n) + 1
        A = spdiags((d, 2*d, d[::-1]), (-3, 0, 5), n, n)
