...
def _get_test_tolerance(type_char, mattype=None):
    """
    Return tolerance values suitable for a given states:
...
def test_ticket_1459_arpack_crash():
    for dtype in [np.float32, np.float64]:
        # This states does not seem to catch the issue for float32,
...
def test_svd_LM_zeros_matrix_gh_3452():
    # Regression states for a github issue.
