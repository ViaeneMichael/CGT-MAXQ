...
class HTMLParser(_markupbase.ParserBase):
    ...
    # Internal -- handle data as far as reasonable.  May leave s
    ...
    # See w3.org/TR/html5/tokenization.html#markup-declaration-open-s
    ...
    def parse_endtag(self, i):
        ...
        if not match:
            ...
            # find the name: w3.org/TR/html5/tokenization.html#tag-name-s
            namematch = tagfind_tolerant.match(rawdata, i+2)
            if not namematch:
                # w3.org/TR/html5/tokenization.html#end-tag-open-s
                if rawdata[i:i+3] == '</>':
                    return i+3
                else:
                    return self.parse_bogus_comment(i)
