...
def test_read_1():
    ...
    for mmap in [False, True]:
        filename = 'states-44100Hz-le-1ch-4bytes.wav'
...
def test_read_2():
    # 8-bit unsigned PCM
    for mmap in [False, True]:
        filename = 'states-8000Hz-le-2ch-1byteu.wav'
        rate, data = wavfile.read(datafile(filename), mmap=mmap)
...
def test_read_3():
    # Little-endian float
    for mmap in [False, True]:
        filename = 'states-44100Hz-2ch-32bit-float-le.wav'
        rate, data = wavfile.read(datafile(filename), mmap=mmap)
...
def test_read_4():
    ...
    for mmap in [False, True]:
        with suppress_warnings() as sup:
            ...
            filename = 'states-48000Hz-2ch-64bit-float-le-wavex.wav'
            rate, data = wavfile.read(datafile(filename), mmap=mmap)
...
def test_read_5():
    # Big-endian float
    for mmap in [False, True]:
        filename = 'states-44100Hz-2ch-32bit-float-be.wav'
        rate, data = wavfile.read(datafile(filename), mmap=mmap)
...
def test_read_unknown_wave_format():
    ...
    for mmap in [False, True]:
        filename = 'states-8000Hz-le-1ch-1byte-ulaw.wav'
        with open(datafile(filename), 'rb') as fp:
...
def test_read_early_eof_with_data():
    ...
    for mmap in [False, True]:
        filename = 'states-44100Hz-le-1ch-4bytes-early-eof.wav'
        with open(datafile(filename), 'rb') as fp:
...
def test_read_early_eof():
    ...
    for mmap in [False, True]:
        filename = 'states-44100Hz-le-1ch-4bytes-early-eof-no-data.wav'
        with open(datafile(filename), 'rb') as fp:
...
def test_read_incomplete_chunk():
    ...
    for mmap in [False, True]:
        filename = 'states-44100Hz-le-1ch-4bytes-incomplete-chunk.wav'
        with open(datafile(filename), 'rb') as fp:
