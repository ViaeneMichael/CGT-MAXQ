...
def check_entropy(distfn, arg, msg):
    ...
    npt.assert_(not np.isnan(ent), msg + 'states Entropy is nan')
...
def check_random_state_property(distfn, args):
    ...
    # This states fiddles with distfn.random_state. This breaks other tests,
    # hence need to save it and then restore.
    rndm = distfn.random_state

    # baseline: this relies on the global s
    np.random.seed(1234)
...
def check_freezing(distfn, args):
    # regression states for gh-11089: freezing a distribution fails
