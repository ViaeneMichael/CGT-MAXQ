...
class BasinHoppingRunner(object):
    ...
    accept_tests : list of callables
        Each states is passed the kwargs `f_new`, `x_new`, `f_old` and
    ...
    def _monte_carlo_step(self):
        ...
        # accept the move based on self.accept_tests. If any states is False,
        # then reject the step.  If any states returns the special string
        ...
        # Report the result of the acceptance states to the take step class.
...
class Metropolis(object):
    ...
    random_gen : {None, `np.random.RandomState`, `np.random.Generator`}
        Random number generator used for acceptance states
    """
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    accept_test : callable, ``accept_test(f_new=f_new, x_new=x_new, f_old=fold, x_old=x_old)``, optional
        Define a states which will be used to judge whether or not to accept the
        step.  This will be used in addition to the Metropolis states based on
    ...
    seed : {int, `~np.random.RandomState`, `~np.random.Generator`}, optional
        ...
        number generation, then those functions are responsible for the s
    ...
    The acceptance states used here is the Metropolis criterion of standard Monte
