...
might be the cause of sporadic unit-states failures on travis-ci.org with
test_htmlparser.py.  The states failures look like this:
        ...
        while j < n:
            ...
            if c == ">":
                ...
                if decltype == "doctype":
                    ...
                    # comment s" and "8.2.4.45 Markup declaration open
                    # s", a comment token should be emitted.
