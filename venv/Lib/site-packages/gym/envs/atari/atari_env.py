...
class AtariEnv(gym.Env, utils.EzPickle):
    ...
    def clone_state(self):
        """Clone emulator s w/o system s. Restoring this s will
        *not* give an identical environment. For complete cloning and restoring
        of the full s, see `{clone,restore}_full_state()`."""
    ...
    def restore_state(self, state):
        """Restore emulator s w/o system s."""
        state_ref = self.ale.decodeState(state)
        self.ale.restoreState(state_ref)
        self.ale.deleteState(state_ref)

    def clone_full_state(self):
        """Clone emulator s w/ system s including pseudorandomness.
        Restoring this s will give an identical environment."""
    ...
    def restore_full_state(self, state):
        """Restore emulator s w/ system s including pseudorandomness."""
        state_ref = self.ale.decodeState(state)
