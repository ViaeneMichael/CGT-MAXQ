...
class TestStructures:
    ...
    def test_arrays_corrupt_idl80(self):
        # states byte arrays with missing nbyte information from IDL 8.0 .sav file
...
def test_null_pointer():
    # Regression states for null pointers.
...
def test_invalid_pointer():
    # Regression states for invalid pointers (gh-4613).
