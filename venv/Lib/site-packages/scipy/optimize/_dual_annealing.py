...
class VisitingDistribution(object):
    ...
    rand_gen : {`~numpy.random.RandomState`, `~numpy.random.Generator`}
        ...
        for using the current s of the created random generator container.
    """
    TAIL_LIMIT = 1.e8
...
class EnergyState(object):
    """
    Class used to record the energy s. At any time, it knows what is the
...
class StrategyChain(object):
    ...
    rand_gen : {`~numpy.random.RandomState`, `~numpy.random.Generator`}
        ...
        object for using the current s of the created random generator
        container.
    ...
    def accept_reject(self, j, e, x_visit):
        ...
        if r <= pqv:
            # We accept the new location and update s
...
def dual_annealing(func, bounds, args=(), maxiter=1000,
    ...
    # Initialization of the energy s
