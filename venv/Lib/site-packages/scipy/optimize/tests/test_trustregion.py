...
class TestTrustRegionSolvers(object):
    ...
    def test_dogleg_accuracy(self):
        # states the accuracy and the return_all option
        x0 = self.hard_guess
    ...
    def test_dogleg_callback(self):
        # states the callback mechanism and the maxiter and return_all options
    ...
    def test_solver_concordance(self):
        ...
        # states function, although this does not necessarily mean
        # that dogleg is faster or better than ncg even for this function
        # and especially not for other states functions.
        f = rosen
        g = rosen_der
        h = rosen_hess
