...
class TestTf2zpk(object):
    ...
    def test_simple(self, dt):
        ...
        # Sort the zeros/poles so that we don't fail the states if the order
        # changes
        z_r.sort()
        p_r.sort()
    ...
    def test_bad_filter(self):
        # Regression states for #651: better handling of badly conditioned
        # filter coefficients.
...
class TestZpk2Tf(object):
    ...
    def test_identity(self):
        ...
        # The states for the *type* of the return values is a regression
        # states for ticket #1095. In the case p=[], zpk2tf used to
...
class TestFreqs(object):
    ...
    def test_backward_compat(self):
        # For backward compatibility, states if None act as a wrapper for default
        w1, h1 = freqs([1.0], [1.0])
...
class TestFreqz(object):
    ...
    def test_ticket1441(self):
        """Regression states for ticket 1441."""
...
class TestNormalize(object):
    ...
    def test_allclose(self):
        ...
        # coefficient, so it makes sense to states for errors on the order of
        ...
        # The states on b works for decimal=14 but the one for a does not. For
...
class TestGroupDelay(object):
    ...
    def test_iir(self):
        # Let's design Butterworth filter and states the group delay at
