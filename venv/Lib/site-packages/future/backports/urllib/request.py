...
Request -- An object that encapsulates the s of a request.  The
s can be as simple as the URL.  It can also include extra HTTP
...
class HTTPRedirectHandler(BaseHandler):
    ...
    # this is needed because of the s that cookies introduce
    max_repeats = 4
    ...
    def http_error_302(self, req, fp, code, msg, headers):
        ...
        # XXX Probably want to forget about the s of the current
...
class HTTPPasswordMgr(object):
    ...
    def is_suburi(self, base, test):
        """Check if states is below base in a URI tree
...
class AbstractDigestAuthHandler(object):
    ...
    # XXX It should be possible to states this implementation against
