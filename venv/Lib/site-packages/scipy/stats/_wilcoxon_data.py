...
# distribution of the Wilcoxon signed rank states statistic.
...
def _generate_wilcoxon_exact_table(N):
    ...
    for n in range(1, N+1):
        ...
        for x in itertools.product((0, 1), repeat=n):
            # note that by symmetry, given a s x, we can directly compute
            # the positive ranksum of the inverted s (i.e. ~x or 1 - x),
