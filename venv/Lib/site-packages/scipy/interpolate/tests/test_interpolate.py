...
class TestInterp1D(object):
    ...
    def test_linear_dtypes(self):
        # regression states for gh-5898, where 1D linear interpolation has been
    ...
    def test_slinear_dtypes(self):
        # regression states for gh-7273: 1D slinear interpolation fails with
        # float32 inputs
    ...
    def test_fill_value(self):
        # states that two-element fill value works
    ...
    def test_all_nans(self):
        # regression states for gh-11637: interp1d core dumps with all-nan `x`
        x = np.ones(10) * np.nan
        y = np.arange(10)
...
class TestPPolyCommon(object):
    # states basic functionality for PPoly and BPoly
...
class TestPPoly(object):
    ...
    def test_roots_all_zero(self):
        # states the code path for the polynomial being identically zero everywhere
        c = [[0], [0]]
        x = [0, 1]
        p = PPoly(c, x)
...
class TestBPolyCalculus(object):
    ...
    def test_deriv_inplace(self):
        ...
        # states both real and complex coefficients
...
class TestPolyConversions(object):
    ...
    def test_broken_conversions(self):
        # regression states for gh-10597: from_power_basis only accepts PPoly etc.
        x = [0, 1, 3]
        c = [[3, 3], [1, 1], [4, 2]]
        pp = PPoly(c, x)
...
class TestRegularGridInterpolator(object):
    ...
    def test_fillvalue_type(self):
        # from #3703; states that interpolator object construction succeeds
