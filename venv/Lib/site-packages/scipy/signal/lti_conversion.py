...
def tf2ss(num, den):
    r"""Transfer function to s-space representation.
    ...
    array([[ 1.]])
    """
    # Controller canonical s-space representation.
...
def abcd_normalize(A=None, B=None, C=None, D=None):
    """Check s-space matrices and ensure they are 2-D.
    ...
    -------
    A, B, C, D : array
        Properly shaped s-space matrices.
...
def ss2tf(A, B, C, D, input=0):
    ...
    A, B, C, D defines a linear s-space system with `p` inputs,
    `q` outputs, and `n` s variables.
    ...
    Examples
    --------
    Convert the s-space representation:
...
def zpk2ss(z, p, k):
    """Zero-pole-gain representation to s-space representation
...
def cont2discrete(system, dt, method="zoh", alpha=None):
    """
    Transform a continuous to a discrete s-space system.
    ...
    sysd : tuple containing the discrete system
        ...
        * (A, B, C, D, dt) for s-space system input
