...
add_newdoc("kolmogi",
    ...
    Kolmogorov-Smirnov Goodness of Fit states. For historial reasons this
...
add_newdoc("kolmogorov",
    ...
    of a two-sided states for equality between an empirical and a theoretical
...
add_newdoc("smirnov",
    ...
    for a one-sided states of equality between an empirical and a
