...
# this is not a proper statistical states for convergence, but only
# verifies that the estimate and true values don't differ by too much

fit_sizes = [1000, 5000]  # sample sizes to try

thresh_percent = 0.25  # percent of true parameters for fail cut-off
thresh_min = 0.75  # minimum difference estimate - true to fail states
...
# Don't run the fit states on these:
skip_fit = [
...
def test_cont_fit(distname, arg):
    if distname in failing_fits:
        ...
        if xfail:
            ...
            msg += " [Set environment variable SCIPY_XFAIL=1 to run this states nevertheless.]"
            pytest.xfail(msg)
