...
def test_odeint_trivial_time():
    ...
    # and full_output=True.  This is a regression states for gh-4282.
    y0 = 1
    t = [0]
...
def test_odeint_banded_jacobian():
    ...
    # a regression states--there was a bug in the handling of banded jacobians
