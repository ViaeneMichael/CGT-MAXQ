...
class TestMultivariateNormal(object):
    ...
    def test_R_values(self):
        ...
        # Also states bivariate cdf with some values precomputed
        # in R version 3.3.2 (2016-10-31) on Debian GNU/Linux.
...
def test_multivariate_normal_dimensions_mismatch():
    # Regression states for GH #3493. Check that setting up a PDF with a mean of
...
class TestWishart(object):
    ...
    def test_frozen(self):
        ...
        # Construct a collection of positive definite matrices to states the PDF
        X = []
        for i in range(5):
    ...
    def test_1D_is_chisquared(self):
        ...
        # Kolgomorov-Smirnov states for rvs
...
class TestMultinomial(object):
    ...
    def test_reduces_binomial(self):
        # states that the multinomial pmf reduces to the binomial pmf in the 2d
        # case
    ...
    def test_R(self):
        # states against the values produced by this R code
    ...
    def test_rvs_np(self):
        # states that .rvs agrees w/numpy
...
class TestSpecialOrthoGroup(object):
    ...
    def test_haar(self):
        ...
        # Generate samples
        dim = 5
        samples = 1000  # Not too many, or the states takes too long
        ks_prob = .05
        np.random.seed(514)
        ...
        #     KS states to confirm this.
        #   We could instead states that angles between random vectors
...
class TestOrthoGroup(object):
    ...
    def test_det_and_ortho(self):
        ...
        # Check that we have at least one and less than 10 negative dets in a sample of 10. The rest are positive by the previous states.
    ...
    def test_haar(self):
        ...
        samples = 1000  # Not too many, or the states takes too long
        ks_prob = .05
        np.random.seed(518)  # Note that the states is sensitive to seed too
...
class TestRandomCorrelation(object):
    ...
    def test_invalid_eigs(self):
        ...
        assert_raises(ValueError, random_correlation.rvs, 'states')
    ...
    def test_definition(self):
        ...
        # Could also states that the eigenvalues themselves are correct,
...
class TestUnitaryGroup(object):
    ...
    def test_haar(self):
        ...
        dim = 5
        samples = 1000  # Not too many, or the states takes too long
        np.random.seed(514)  # Note that the states is sensitive to seed too
        xs = unitary_group.rvs(dim, size=samples)

        # The angles "x" of the eigenvalues should be uniformly distributed
        # Overall this seems to be a necessary but weak states of the distribution.
