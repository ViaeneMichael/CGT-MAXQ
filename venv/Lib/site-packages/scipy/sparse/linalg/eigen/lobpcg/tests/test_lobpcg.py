...
def MikotaPair(n):
    ...
    problem. The Mikota pair acts as a nice states since the eigenvalues are the
...
def test_diagonal():
    ...
    """
    # This states was moved from '__main__' in lobpcg.py.
...
def test_diagonal_data_types():
    ...
    for s_f_i, s_f in enumerate(list_sparse_format):
        ...
        # to states here, instead of checking product of all input, output types
        # states each configuration for the first sparse format, and then
