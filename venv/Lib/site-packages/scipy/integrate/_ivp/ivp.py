...
def solve_ivp(fun, t_span, y0, method='RK45', t_eval=None, dense_output=False,
    ...
    N-D vector-valued function (s), and an N-D
    ...
    y0 : array_like, shape (n,)
        Initial s. For problems in the complex domain, pass `y0` with a
    ...
    events : callable, or list of callables, optional
        ...
        s. Each function must have the signature ``event(t, y)`` and return
