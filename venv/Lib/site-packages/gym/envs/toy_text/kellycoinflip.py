...
class KellyCoinflipEnv(gym.Env):
    ...
    Coin' (https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2856963), to states human
...
class KellyCoinflipGeneralizedEnv(gym.Env):
    ...
    def __init__(self, initial_wealth=25.0, edge_prior_alpha=7, edge_prior_beta=3,
        ...
        # clip_distributions=True asserts that s and action space are not modified at reset()
