...
def test_footprint_all_zeros():
    # regression states for gh-6876: footprint of all zeros segfaults
...
def test_rank_filter_noninteger_rank():
    # regression states for issue 9388: ValueError for
...
def test_size_footprint_both_set():
    # states for input validation, expect user warning when
