...
class TestConvolve(_TestConvolve):
    ...
    def test_convolve_method(self, n=100):
        ...
        # These are random arrays, which means states is much stronger than
    ...
    def test_convolve_method_large_input(self):
        # This is really a states that convolving two large integers goes to the
...
class TestConvolve2d(_TestConvolve2d):
    ...
    @pytest.mark.slow
    @pytest.mark.xfail_on_32bit("Can't create large array for states")
...
class TestFFTConvolve(object):
    ...
    def test_empty(self):
        # Regression states for #1745: crashes with 0-length input.
    ...
    def test_random_data_multidim_axes(self, axes):
        ...
        # use 1 for dimension 2 in a and 3 in b to states broadcasting
...
class TestMedFilt(object):
    ...
    def test_none(self):
        ...
        with pytest.warns(UserWarning):
            signal.medfilt(None)
        # Expand on this states to avoid a regression with possible contiguous
...
class TestResample(object):
    def test_basic(self):
        ...
        # Regression states for issue #3603.
        ...
        # states for issue #6505 - should not modify window.shape when axis ≠ 0
...
class TestCSpline1DEval(object):
    ...
    def test_complex(self):
        ...
        # determine new states x value and interpolate
        xnew = np.array([0.5])
...
class _TestLinearFilter(object):
    ...
    def test_empty_zi(self):
        # Regression states for #880: empty array for zi crashes.
        x = self.generate((5,))
        a = self.convert_dtype([1])
    ...
    def test_lfiltic_bad_zi(self):
        # Regression states for #3699: bad initial conditions
        a = self.convert_dtype([1])
        b = self.convert_dtype([1])
...
def test_lfilter_bad_object():
    ...
    # Regression states for ticket #1452.
...
class TestLFilterZI(object):
    ...
    def test_scale_invariance(self):
        # Regression states.  There was a bug in which b was not correctly
...
class TestFiltFilt(object):
    ...
    def test_sine(self):
        ...
        # (Regression states for ticket #1620)
    ...
    def test_acoeff(self):
        ...
        # states for 'a' coefficient as single number
...
def check_filtfilt_gust(b, a, shape, axis, irlen=None):
    ...
    # Also call the private function so we can states the ICs.
...
def test_filtfilt_gust():
    ...
    for irlen in [None, approx_impulse_len]:
        ...
        # 3-d states case; states each axis.
        for axis in range(3):
            shape = [2, 2, 2]
...
class TestDecimate(object):
    ...
    def test_shape(self):
        # Regression states for ticket #1480.
        z = np.zeros((30, 30))
...
class TestHilbert(object):
    ...
    def test_hilbert_axisN(self):
        ...
        # the next states is just a regression states,
...
class TestPartialFractionExpansion(object):
    ...
    def test_inverse_unique_roots_different_rtypes(self):
        # This states was inspired by github issue 2496.
        r = [3 / 10, -1 / 6, -2 / 15]
        p = [0, -2, -5]
        k = []
        b_expected = [0, 1, 3]
    ...
    def test_invresz_one_coefficient_bug(self):
        # Regression states for issue in gh-4646.
        r = [1]
        p = [2]
        k = [0]
        b, a = invresz(r, p, k)
...
class TestSOSFilt(object):
    ...
    def test_sosfilt_zi(self, dt):
        ...
        # Expected steady s value of the step response of this filter:
