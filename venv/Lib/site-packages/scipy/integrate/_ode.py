...
class ode(object):
    ...
    *Note*: The first two arguments of ``f(t, y, ...)`` are in the
    ...
    def get_return_code(self):
        ...
        -4           Repeated error states failures. (Check all input.)
        ...
        -4           Repeated error states failures (internal error).
...
class IntegratorBase(object):
    ...
    def acquire_new_handle(self):
        # Some of the integrators have internal s (ancient
    ...
    # XXX: __str__ method for getting visual s of the integrator
