...
class TestKMean(object):
    ...
    def test_kmeans2_high_dim(self):
        # states kmeans2 when the number of dimensions exceeds the number
        # of input points
        data = TESTDATA_2D
    ...
    def test_kmeans2_empty(self):
        # Regression states for gh-1032.
        assert_raises(ValueError, kmeans2, [], 2)

    def test_kmeans_0k(self):
        # Regression states for gh-1073: fail when k arg is 0.
    ...
    def test_kmeans2_kpp_low_dim(self):
        # Regression states for gh-11462
