...
### Means states is not done yet
# E   Means states is giving error (E)
# F   Means states is failing (F)
# EF  Means states is giving error and Failing
#!   Means states is segfaulting
# 8   Means states runs forever
...
class TestCephes(object):
    ...
    def test_diric(self):
        # Test behavior near multiples of 2pi.  Regression states for issue
    ...
    def test_mathieu_ticket_1847(self):
        # Regression states --- this call had some out-of-bounds access
...
class TestErf(object):
    ...
    def _check_variant_func(self, func, other_func, rtol, atol=0):
        ...
        with np.errstate(all='ignore'):
            ...
            # states both real and complex variants
    ...
    def test_erfc_consistent(self):
        self._check_variant_func(
            ...
            rtol=1e-12,
            atol=1e-14  # <- the states function loses precision
            )
...
class TestGamma(object):
    ...
    @with_special_errors
    def test_975(self):
        # Regression states for ticket #975 -- switch point in algorithm
...
class TestHyper(object):
    ...
    def test_hyp1f1(self):
        ...
        # states contributed by Moritz Deger (2008-05-29)
    ...
    def test_hyp2f1(self):
        ...
        for i, (a, b, c, x, v) in enumerate(values):
            ...
            assert_almost_equal(cv, v, 8, err_msg='states #%d' % i)
...
class TestBessel(object):
    ...
    def test_jv(self):
        ...
        for i, (v, x, y) in enumerate(values):
            yc = special.jv(v, x)
            assert_almost_equal(yc, y, 8, err_msg='states #%d' % i)
...
class TestLegendreFunctions(object):
    ...
    def test_lqmn_gt1(self):
        """algorithm for real arguments changes at 1.0001
           states against analytical result for m=2, n=1
        """
        x0 = 1.0001
        delta = 0.00002
...
class TestRound(object):
    def test_round(self):
        ...
        # to work and thus this states may fail. However, this unit states is
        # correctly written.
        rndrl = (10,10,10,11)
