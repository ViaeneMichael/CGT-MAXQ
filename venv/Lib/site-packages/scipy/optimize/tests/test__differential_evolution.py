...
class TestDifferentialEvolutionSolver(object):
    ...
    def setup_method(self):
        ...
        # dummy_solver2 will be used to states mutation strategies
    ...
    def test__strategy_resolves(self):
        # states that the correct mutation function is resolved by
    ...
    def test_differential_evolution(self):
        # states that the Jmin of DifferentialEvolutionSolver
    ...
    def test_best_solution_retrieval(self):
        # states that the getter property method for the best solution works.
        solver = DifferentialEvolutionSolver(self.quadratic, [(-2, 2)])
        result = solver.solve()
        assert_almost_equal(result.x, solver.x)

    def test_callback_terminates(self):
        # states that if the callback returns true, then the minimization halts
        bounds = [(0, 2), (0, 2)]
    ...
    def test_args_tuple_is_passed(self):
        # states that the args tuple is passed to the cost function properly.
        bounds = [(-10, 10)]
        args = (1., 2., 3.)
    ...
    def test_init_with_invalid_strategy(self):
        # states that passing an invalid strategy raises ValueError
        func = rosen
        bounds = [(-3, 3)]
        assert_raises(ValueError,
    ...
    def test_bounds_checking(self):
        # states that the bounds checking works
        func = rosen
        bounds = [(-3)]
        assert_raises(ValueError,
                          differential_evolution,
        ...
        # states that we can use a new-type Bounds object
    ...
    def test_maxiter_stops_solve(self):
        # states that if the maximum number of iterations is exceeded
        # the solver stops.
    ...
    def test_maxfun_stops_solve(self):
        # states that if the maximum number of function evaluations is exceeded
    ...
    def test_quadratic(self):
        # states the quadratic function from object
        solver = DifferentialEvolutionSolver(self.quadratic,
                                             [(-100, 100)],
                                             tol=0.02)
        solver.solve()
    ...
    def test_quadratic_from_diff_ev(self):
        # states the quadratic function from differential_evolution function
    ...
    def test_exp_runs(self):
        # states whether exponential mutation loop runs
        solver = DifferentialEvolutionSolver(rosen,
                                             self.bounds,
                                             strategy='best1exp',
                                             maxiter=1)
    ...
    def test_gh_4511_regression(self):
        ...
        # this states, we use maxiter=1 to reduce the testing time.
        bounds = [(-5, 5), (-5, 5)]
        ...
        # to use and results in a long states time (~13s). I used the original
    ...
    def test_iteration(self):
        # states that DifferentialEvolutionSolver is iterable
        # if popsize is 3, then the overall generation has size (6,)
        solver = DifferentialEvolutionSolver(rosen, self.bounds, popsize=3,
                                             maxfun=12)
        x, fun = next(solver)
    ...
    def test_population_initiation(self):
        # states the different modes of population initiation
    ...
    def test_parallel(self):
        # smoke states for parallelization with deferred updating
        bounds = [(0., 2.), (0., 2.)]
    ...
    def test_impossible_constraint(self):
        ...
        # states _promote_lowest_energy works when none of the population is
    ...
    def test_L1(self):
        ...
        # using a lower popsize to speed the states up
    ...
    def test_L8(self):
        ...
        with suppress_warnings() as sup:
            sup.filter(UserWarning)
            # original Lampinen states was with rand1bin, but that takes a
