...
request. This diagram details these s transitions:
...
Note: this enforcement is applied by the HTTPConnection class. The
      HTTPResponse class does not enforce this s machine, which
    ...
    def _read_status(self):
        ...
        try:
            ...
            try:
                ...
                # empty version will cause next states to fail.
                version = ""
...
class HTTPConnection(object):
    ...
    def getresponse(self):
        ...
        If the HTTPConnection is in the correct s, returns an
