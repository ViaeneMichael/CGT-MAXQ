...
def max_len_seq(nbits, state=None, length=None, taps=None):
    ...
    state : array_like, optional
        ...
        producing a repeatable representation. If ``s`` is all
    ...
    s : array
        The final s of the shift register.
    ...
    if state.ndim != 1 or state.size != nbits:
        raise ValueError('s must be a 1-D array of size nbits')
    if np.all(state == 0):
        raise ValueError('s must not be all zeros')
