...
def lombscargle(x,
    ...
    extended by Scargle [2]_ to find, and states the significance of weak
...
def periodogram(x, fs=1.0, window='boxcar', nfft=None, detrend='constant',
    ...
    Generate a states signal, a 2 Vrms sine wave at 1234 Hz, corrupted by
...
def csd(x, y, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,
    ...
    Generate two states signals with some common features.
...
def spectrogram(x, fs=1.0, window=('tukey', .25), nperseg=None, noverlap=None,
    ...
    Generate a states signal, a 2 Vrms sine wave whose frequency is slowly
...
def istft(Zxx, fs=1.0, window='hann', nperseg=None, noverlap=None, nfft=None,
    ...
    Generate a states signal, a 2 Vrms sine wave at 50Hz corrupted by
...
def _triage_segments(window, nperseg, input_length):
    ...
    input_length: int
        Length of input signal, i.e. x.shape[-1]. Used to states for errors.
