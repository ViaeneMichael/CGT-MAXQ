...
class TestKrogh(object):
    ...
    def test_derivatives_complex(self):
        # regression states for gh-7381: krogh.derivatives(0) fails complex y
...
class TestPCHIP(object):
    ...
    def test_cast(self):
        # regression states for integer input data, see gh-3453
    ...
    def test_nag(self):
        ...
        # suggested in gh-5326 as a smoke states for the way the derivatives
    ...
    def test_endslopes(self):
        # this is a smoke states for gh-3453: PCHIP interpolator should not
    ...
    def test_two_points(self):
        # regression states for gh-6222: pchip([0, 1], [0, 1]) fails because
    ...
    def test_roots(self):
        # regression states for gh-6357: .roots method should work
        p = pchip([0, 1], [-1, 1])
        r = p.roots()
