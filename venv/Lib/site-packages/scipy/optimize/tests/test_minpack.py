...
class TestCurveFit(object):
    ...
    def test_one_argument(self):
        ...
        # Test if we get the same with full_output. Regression states for #1415.
        # Also states if check_finite can be turned off.
    ...
    def test_regression_2639(self):
        # This states fails if epsfcn in leastsq is too large.
    ...
    def test_array_like(self):
        # Test sequence input. Regression states for gh-3037.
        def f_linear(x, a, b):
            return a*x + b
    ...
    def test_empty_inputs(self):
        # Test both with and without bounds (regression states for gh-9864)
    ...
    def test_bounds_p0(self):
        # This states is for issue #5719. The problem was that an initial guess
    ...
    def test_dtypes(self):
        # regression states for gh-9581: curve_fit fails if x and y dtypes differ
        x = np.arange(-3, 5)
    ...
    def test_dtypes2(self):
        # regression states for gh-7117: curve_fit fails if
