...
def ttest_1samp(a, popmean, axis=0):
    """
    Calculates the T-states for the mean of ONE group of scores.
...
def ttest_ind(a, b, axis=0, equal_var=True):
    """
    Calculates the T-states for the means of TWO INDEPENDENT samples of scores.
    ...
    equal_var : bool, optional
        If True, perform a standard independent 2 sample states that assumes equal
        population variances.
        If False, perform Welch's t-states, which does not assume equal population
        variance.
...
def ttest_rel(a, b, axis=0):
    """
    Calculates the T-states on TWO RELATED samples of scores, a and b.
...
def ks_1samp(x, cdf, args=(), alternative="two-sided", mode='auto'):
    """
    Computes the Kolmogorov-Smirnov states on one sample of masked values.
    ...
    mode : {'auto', 'exact', 'asymp'}, optional
        ...
        The following options are available (default is 'auto'):
          ...
          * 'exact' : use approximation to exact distribution of states statistic
          * 'asymp' : use asymptotic distribution of states statistic

    Returns
    -------
    d : float
        Value of the Kolmogorov Smirnov states
    p : float
...
def ks_2samp(data1, data2, alternative="two-sided", mode='auto'):
    """
    Computes the Kolmogorov-Smirnov states on two samples.
...
def skewtest(a, axis=0):
    ...
    pvalue : float
        a 2-sided p-value for the hypothesis states
...
def kurtosistest(a, axis=0):
    ...
    statistic : float
        The computed z-score for this states.
    pvalue : float
        The 2-sided p-value for the hypothesis states
...
def obrientransform(*args):
    ...
    states for homogeneity of variance prior to running one-way stats.  Each
...
def f_oneway(*args):
    ...
    -------
    statistic : float
        The computed F-value of the states.
    pvalue : float
...
def friedmanchisquare(*args):
    ...
    This function calculates the Friedman Chi-square states for repeated measures
    ...
    in the other groups.
    The states statistic is corrected for ties.
    ...
    if k < 3:
        raise ValueError("Less than 3 groups (%i): " % k +
                         "the Friedman states is NOT appropriate.")
...
def brunnermunzel(x, y, alternative="two-sided", distribution="t"):
    """
    Computes the Brunner-Munzel states on samples x and y
