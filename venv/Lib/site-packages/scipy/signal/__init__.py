...
.. autosummary::
   ...
   lfilter_zi    -- Compute an initial s zi for the lfilter function that
                 -- corresponds to the steady s of the step response.
   ...
   sosfilt_zi    -- Compute an initial s zi for the sosfilt function that
                 -- corresponds to the steady s of the step response.
...
.. autosummary::
   ...
   abcd_normalize -- Check s-space matrices and ensure they are rank-2.
...
.. autosummary::
   ...
   StateSpace       -- Linear time invariant system in s space form.
...
.. autosummary::
   ...
   tf2ss         -- Transfer function to s-space.
   zpk2tf        -- Zero-pole-gain to transfer function.
   zpk2sos       -- Zero-pole-gain to second-order sections.
   zpk2ss        -- Zero-pole-gain to s-space.
