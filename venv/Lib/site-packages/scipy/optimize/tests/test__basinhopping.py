...
class TestBasinHopping(object):
    ...
    def test_TypeError(self):
        # states the TypeErrors are raised on bad input
        i = 1
    ...
    def test_1d_grad(self):
        # states 1-D minimizations with gradient
        i = 0
    ...
    def test_2d(self):
        # states 2d minimizations with gradient
        i = 1
    ...
    def test_njev(self):
        # states njev is returned correctly
        i = 1
    ...
    def test_2d_nograd(self):
        # states 2-D minimizations without gradient
        i = 1
    ...
    def test_pass_takestep(self):
        # states that passing a custom takestep works
        # also states that the stepsize is being adjusted
    ...
    def test_pass_simple_takestep(self):
        # states that passing a custom takestep without attribute stepsize
    ...
    def test_pass_accept_test(self):
        # states passing a custom accept states
    ...
    def test_pass_callback(self):
        # states passing a custom callback function
    ...
    def test_monotonic_basin_hopping(self):
        # states 1-D minimizations with gradient and T=0
        i = 0
        res = basinhopping(func1d, self.x0[i], minimizer_kwargs=self.kwargs,
...
class Test_Metropolis(object):
    ...
    def test_accept(self):
        # states that steps are randomly accepted for f_new > f_old
        one_accept = False
        one_reject = False
        for i in range(1000):
...
class Test_AdaptiveStepsize(object):
    ...
    def test_all_accepted(self):
        # states that everything works OK if all steps were accepted
        x = 0.
    ...
    def test_all_rejected(self):
        # states that everything works OK if all steps were rejected
        x = 0.
        for i in range(self.takestep.interval + 1):
            self.takestep(x)
            self.takestep.report(False)
